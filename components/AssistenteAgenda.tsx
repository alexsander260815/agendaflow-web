...
export default function AssistenteAgenda() {
  ...
  return (
    <>
      <button onClick={ouvir} aria-label='Abrir assistente por voz' className='fixed bottom-72 right-5 z-20 flex h-14 w-14 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-xl transition-transform hover:scale-105 md:bottom-44 md:right-5'><Mic size={22} /></button>
