...
export default function AssistenteAgenda() {
  ...
  return (
    <>
      <button onClick={ouvir} aria-label='Abrir assistente por voz' className='fixed bottom-20 right-4 z-20 flex h-13 w-13 items-center justify-center rounded-full bg-accent text-accent-foreground shadow-xl transition-transform hover:scale-105 md:bottom-6 md:right-6'><Mic size={22} /></button>
